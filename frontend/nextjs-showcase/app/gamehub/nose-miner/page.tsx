...
import styles from './NoseMiner.module.css'
import { marioMusic } from '@/lib/gamehub/MarioMusic'
...
export default function NoseMiner() {
  ...
  return (
    <div className={styles.noseMinerContainer}>
        ...
        <div className={styles.gameArea}>
            {isLoading && <div className={styles.loading}>Loading Face Tracking...</div>}
            {showWinModal && (
                <div className={styles.winOverlay}>
                    ...
                    <button className={styles.resetBtn} onClick={resetGrid}>Play Again</button>
                </div>
            )}
            <canvas
                ref={canvasRef}

        ...
        <>
            {!gameStarted && !gameOver && (
                <div style={{
                    ...
                    <h1 className="neon-text" style={{ fontSize: '4rem', margin: 0, color: 'cyan' }}>NEON RACER</h1>
                    <p className="hud-text" style={{ fontSize: '1.5rem', color: 'white', marginTop: 20 }}>TILT HEAD TO STEER</p>
                    <button 
                        onClick={() => {
                            audioManager.init();
                            startGame();
            ...
            {gameOver && (
                <div style={{
                    ...
                    <h1 className="neon-text" style={{ fontSize: '5rem', margin: 0, color: 'red', textShadow: '0 0 20px red' }}>GAME OVER</h1>
                    <p className="hud-text" style={{ fontSize: '2rem', color: 'white', marginTop: 20 }}>FINAL SCORE: {score}</p>
                    <button 
                        onClick={resetGame}
                        style={{
                            marginTop: 40,
...
export function NeonRacerScene() {
